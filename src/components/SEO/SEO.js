...
const SEO = ({
  ...
  const tagLine = wpSettings.generalSettingsDescription || fallback.description;
  ...
  return (
    <>
      <Helmet>
        ...
        {postDescription && (
          <meta name="description" content={he.unescape(postDescription)} />
        )}
        {facebookMetaImage && <meta name="image" content={facebookMetaImage} />}
        ...
        {fallback.facebookAppID && (
          <meta property="fb:app_id" content={fallback.facebookAppID} />
        )}
        {datePublished && (
